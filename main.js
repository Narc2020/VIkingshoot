...
function getModelDescription() {
    ...
    for (var i = 0; i < selectedModel.length; i++) {
        if (selectedModel[i].checked) {
            ...
            divobj.innerHTML += " <tr class='item - row'>" + "<td class='item - name'>" + gun_model_ItemName + "</td>" + "<td class='description'>" + gun_model_description + "</td>" + "<td><span class='sale - price'>" + gun_model_Price_int + "</span></td>" + "<td><span class='qty'>" + gun_model_qty + "</span></td>" + "<td><span class='sale-price'>" + gun_model_Price_int + "</span></td>" + "<td><span class='price' > " + (gun_model_Price_int * gun_model_qty) + "</span ></td >" + "</tr>";
...
function getAccesoriesDescription() {
    var gun_accesories_description = "";
    var theForm = document.forms["gunform"];
    var selectedModel = theForm.elements["gun_accesories"];
    for (var i = 0; i < selectedModel.length; i++) {
        if (selectedModel[i].checked) {
            var gun_accesories_ItemName = selectedModel[i].getAttribute("name");
            console.log("gun_accesories_ItemName");
            break;
        }
    }
    return gun_accesories_description;
}
/**************************Date*****************************/
